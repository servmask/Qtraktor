...
public:
    ...
    static bool processFileContentStreaming(QIODevice *source, qint64 contentSize,
                                            QIODevice *dest, bool isCompressed,
                                            const QString &fileName,
                                            CompressionType compressionType = COMPRESSION_NONE,
                                            QString *errorMsg = nullptr);

    static bool processFileContentWithPasswordStreaming(QIODevice *source, qint64 contentSize,
                                                        QIODevice *dest, bool isCompressed,
                                                        const QString &fileName, const QString &password,
                                                        CompressionType compressionType = COMPRESSION_NONE,
                                                        QString *errorMsg = nullptr);
...
private:
    ...
    static bool streamCompressed(QIODevice *source, qint64 contentSize, QIODevice *dest,
                                  CompressionType type, QString *errorMsg);
    static bool streamEncryptedOnly(QIODevice *source, qint64 contentSize, QIODevice *dest,
