...
src/
  ...
  cryptoutils.h/cpp     Streaming decompression (zlib, bzip2) and AES-256-CBC
                        decryption (vendored tiny-AES-c, no OpenSSL).
...
- `vendor/bzip2-1.0.8/` and `vendor/tiny-aes-c/` are vendored. Do not modify.
